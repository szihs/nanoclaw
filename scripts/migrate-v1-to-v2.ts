 ...
 *   {out-dir}/coworker-types.json  — v1 type registry (reference only — v2 types live in container/{spines,skills}/<type>/coworker-types.yaml and must be ported by hand if they aren't already covered by a lego skill)
 *   {out-dir}/templates/           — v1 template directory (reference only — v2 only keeps groups/templates/instructions/; per-project role templates moved under container/skills/<name>/)
