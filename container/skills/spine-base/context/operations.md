...
Use standard Markdown by default. Channel-specific formatting rules (if any) are provided by the channel skill installed on this instance — check the formatting section below if one is present.
