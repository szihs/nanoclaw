...
Project-agnostic recurring sweep. Specialize by declaring the project's source skills in the calling workflow's `uses.skills` (e.g. `slang-github`, `slang-discord`).
