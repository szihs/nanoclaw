...
Project-agnostic triage. Specialize by picking the project's investigation skills (e.g. `slang-github`, `slang-explore`) via the calling workflow's `uses.skills`. This workflow is the shape — the skills are the parts.
