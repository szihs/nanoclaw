...
Do NOT build the container yet — nv-main and project merges (steps 4a, 5, 5a) will change the codebase. The container build moves to step 5b after all merges are complete.
